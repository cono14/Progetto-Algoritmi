...
package connectx.L2;
 ...
 public class L2 implements CXPlayer {
      ...
      * </p>
      */
      private int minimax(CXBoard B, int depth, boolean maximizingPlayer, int alpha, int beta) throws TimeoutException {
    ...
    public int selectColumn(CXBoard B) {
        ...
        int save = B.getAvailableColumns()[rand.nextInt(B.getAvailableColumns().length)]; // Save a random column
        int bestColumn = -1;
        ...
        for (int i : B.getAvailableColumns()) {
            try {
                ...
                CXBoard child = B.clone();
                child.markColumn(i);
                int value = minimax(child, 3, false, Integer.MIN_VALUE, Integer.MAX_VALUE); // depth 3
                if (value > bestValue) {
                    bestValue = value;
                    bestColumn = i;
                }
        ...
        return (bestColumn != -1) ? bestColumn : save;
    }
